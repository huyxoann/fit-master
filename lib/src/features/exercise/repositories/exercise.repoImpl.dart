...
class ExerciseRepositoryImpl implements ExerciseRepository {
  ...
  Future<GetListExerciseResponse> fetchExercises({
    ...
    print(
        "Starting API call with experienceLevel=$experienceLevel, targetMuscle=$targetMuscle, offset=$offset");
    try {
  ...
  Future<ExerciseDetailResponse> fetchExerciseDetail(
      {required int exerciseId, String? token}) async {
    if (kDebugMode) {
  ...
  @override
  Future<GetListExerciseResponse> fetchExercisesWithLevel(
      {required int experienceLevel,
      required int offset,
      required int limit,
      String? token}) async {
